...
4. **Use the Python Engine:** You have access to a background script `rpg_setup/engine.py`. You MUST use the `run_command` tool to execute this script for state changes:
